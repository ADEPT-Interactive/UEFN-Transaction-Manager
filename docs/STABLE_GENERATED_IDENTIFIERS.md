...
`schemaVersion` remains the managed-data schema marker. A separate generated API marker is deliberately deferred until the first actual public-symbol migration, when it will have a concrete compatibility decision to represent.
