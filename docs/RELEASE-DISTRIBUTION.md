...
UEM 4.0.0 remains historically intact with its original GitHub updater configuration and assets. Starting with 4.0.1, follow the split distribution contract in [DISTRIBUTION.md](DISTRIBUTION.md).

The v4.0.1 GitHub Release custom assets are only:

- `UEFN-Entitlement-Manager-Setup.exe`
- `UEFN-Entitlement-Manager-Portable.zip`
