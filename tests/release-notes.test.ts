...
test('every published 4.3.x release has checked-in version-specific notes', () => {
  const versions = ['4.3.2', '4.3.3', '4.3.4', '4.3.5', '4.3.6', '4.3.7'];
  ...
  assert.equal(currentVersion, '4.3.7');
