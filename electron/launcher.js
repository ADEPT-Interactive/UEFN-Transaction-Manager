const state = { projects: [], selectedId: null, status: 'Finding active and recent UEFN projects…', busy: false, showcaseMode: false };
let updateState = null;
const byId = id => document.getElementById(id);

const discordMark = document.querySelector('#discord svg');
if (discordMark) {
  const canonicalDiscordMark = document.createElement('img');
  canonicalDiscordMark.className = 'discord-mark';
  canonicalDiscordMark.src = '/discord-icon.svg';
  canonicalDiscordMark.alt = '';
  discordMark.replaceWith(canonicalDiscordMark);
}
