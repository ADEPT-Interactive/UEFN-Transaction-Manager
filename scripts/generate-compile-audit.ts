...
const entitlements: EntitlementItem[] = [
  {
    ...
    autoConsume: true, iconTexture: 'EntitlementIcons.UTM_PlaceholderIcon',
  ...
  },
  {
    ...
    autoConsume: false, iconTexture: 'EntitlementIcons.UTM_PlaceholderIcon',
    ...
    alternateOffers: [{
      ...
      priceVBucks: 300, iconTexture: 'EntitlementIcons.UTM_PlaceholderIcon',
...
const bundles: BundleOffer[] = [
  {
    ...
    description: 'Used to verify nested bundle contents.', priceVBucks: 225, iconTexture: 'EntitlementIcons.UTM_PlaceholderIcon',
  ...
  },
  {
    ...
    description: 'Used to verify generated static and nested bundle syntax.', priceVBucks: 250, iconTexture: 'EntitlementIcons.UTM_PlaceholderIcon',
  ...
  },
  {
    ...
    description: 'Used to verify authoritative MaxCount and runtime offer construction.', priceVBucks: 275, iconTexture: 'EntitlementIcons.UTM_PlaceholderIcon',
