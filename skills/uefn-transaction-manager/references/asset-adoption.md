...
3. UTM routes the path through the existing authenticated editor connector, normalization, configured icon folder, and hidden preview persistence. It updates the catalog only after the controlled job completes.
